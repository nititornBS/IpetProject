...
namespace RogueEngine.UI
{
    public class LobbyCreatePanel : UIPanel
    {
        ...
        private async void LoadHostIP()
        {
            await LobbyClient.Get().LoadHostIP();
        }
        ...
        public void RefreshLoad()
        {
            ...
            int index = 0;
            List<World> saves = World.GetAllMultiplayer();
        ...
        public void OnClickLoad(LoadUI ui)
        {
            ...
            LobbyClient.Get().CreateGame(world.title, world.filename, true);
        }
