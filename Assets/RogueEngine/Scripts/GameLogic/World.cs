...
namespace RogueEngine
{
    ...
    public class World
    {
        ...
        public static void SetLastSaveMulti(string filename)
        {
            if (SaveTool.IsValidFilename(filename))
            {
                PlayerPrefs.SetString(last_save_multi_id, filename);
            }
        }

        public static string GetLastSaveMulti()
        {
            string name = PlayerPrefs.GetString(last_save_multi_id, "");
            return name;
        }
        ...
        public static List<World> GetAllSolo()
        {
            ...
            foreach (string file in files)
            {
                ...
                if (world != null && !world.IsMultiplayer())
                    worlds.Add(world);
            }
            return worlds;
        }

        public static List<World> GetAllMultiplayer()
        {
            List<World> worlds = new List<World>();
            List<string> files = SaveTool.GetAllSave(extension);
            foreach (string file in files)
