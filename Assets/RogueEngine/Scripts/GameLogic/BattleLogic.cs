    ...
    public class BattleLogic
    {
        ...
        public virtual void EndTurn()
        {
            ...
            if(battle_data.initiatives.Count > 0)
                battle_data.initiatives.RemoveAt(0);

            BattleCharacter champion = battle_data.GetActiveCharacter();
            DrawEnemyHand(champion);

            //Remove once status
            champion.RemoveOnceStatus();
        ...
        public virtual void RemoveFromInitiative(BattleCharacter character)
        {
