...
namespace RogueEngine
{
    ...
    public class DataLoader : MonoBehaviour
    {
        ...
        private void CheckDeckData()
        {
            ...
            if(gdata.test_scenario == null || gdata.test_battle == null || gdata.test_champion == null)
                Debug.Log("Test is null in Resources/GameplayData");
            ...
            foreach (DeckData deck in DeckData.GetAll())
            {
                ...
                foreach (CardData item in deck.items)
                {
                    if (item == null)
                        Debug.LogError(deck.id + " has null item");
                }
