...
namespace RogueEngine.UI
{
    public class UpgradePanel : MapPanel
    {
        ...
        public override void RefreshPanel()
        {
            ...
            foreach (DeckLine line in card_lines)
        ...
        private DeckLine CreateLine(ChampionCard card)
        {
            GameObject cobj = Instantiate(card_line_prefab, content_grid.transform);
            DeckLine line = cobj.GetComponent<DeckLine>();
            line.SetLine(card);
        ...
        public void OnClickCard(DeckLine dline)
        {
